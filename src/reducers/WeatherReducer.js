...
const WeatherReducer$ = Rx.Observable
  ...
  return Rx.Observable
    .ajax({ url:`https://api.openweathermap.org/data/2.5/forecast?lat=${correctCoords(coords.lat.toFixed(2))}&lon=${correctCoords(coords.lng.toFixed(1))}&APPID=${API_KEY_WEATHER} `, crossDomain: true })
    .retryWhen(err$ => [])
